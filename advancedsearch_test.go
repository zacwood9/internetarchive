...
func TestAdvancedSearch_Url(t *testing.T) {
	search := AdvancedSearch{
		...
		Options{[]string{"avg_rating", "date", "downloads", "identifier"}, "downloads desc", 50}}
...
func TestAdvancedSearch_Search(t *testing.T) {
	search := AdvancedSearch{
		Query{"GratefulDead", "1977-05-08 OR 77-05-08"},
		Options{[]string{"avg_rating", "date", "downloads", "identifier"}, "downloads desc", 1}}
